...
function encodeURL(url) {
  // Використовуємо вбудовану функцію // Задача 7: Напишіть функцію, яка кодує URL.
...
console.log(
  ...
  encodeURL("https://ex ample.com")
); // Виведе "https://ex%20ample.com", щоб закодувати введений URL.
  // Ця функція повертає закодований URL, замінивши небезпечні символи на їх процентне кодування.
  // Повертаємо закодований URL.
  return // Задача 7: Напишіть функцію, яка кодує URL.
